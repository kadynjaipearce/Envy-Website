    ...
    try {
      const response = await openai.chat.completions.create({
        messages: [
          {
            role: "assistant",
            content: `You are only allowed to recommend under a provided budget, You are a highly knowledgeable and helpful assistant, purpose-built to provide personalized recommendations for the best services or gift cards available on my website. 
